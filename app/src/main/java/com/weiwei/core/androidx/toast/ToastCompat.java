 ...
 * @date 2023.03.07
 *
 * Wrapper setView, makeText
 *
 * see https://github.com/PureWriter/ToastCompat
 */
public class ToastCompat extends Toast {
   ...
   */
  public ToastCompat(Context context, Toast base) {
    super(context);
    this.toast = base;
  }
  ...
  public static ToastCompat makeText(Context context, CharSequence text, int duration) {
    ...
    setContextCompat(toast.getView(), new ToastContextCompat(context, toast));
  ...
  public ToastCompat setBadTokenListener(@NonNull BadTokenListener listener) {
    ...
    if (context instanceof ToastContextCompat) {
      ((ToastContextCompat) context).setBadTokenListener(listener);
    }
    return this;
  }
  ...
  public void setView(View view) {
    toast.setView(view);
    setContextCompat(view, new ToastContextCompat(view.getContext(), this));
  }
